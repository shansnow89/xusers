...
echo curl -L --retry 5 --retry-delay 2 -o "%%TEMP%%\chrome.msi" https://dl.google.com/chrome/install/googlechromestandaloneenterprise64.msi ^>nul 2^>^&1
echo start /wait msiexec /i "%%TEMP%%\chrome.msi" /quiet /norestart ^>nul 2^>^&1
